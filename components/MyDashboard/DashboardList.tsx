  ...
  return (
    <>
      <div className="mx-auto w-fit">
        <ul className="h-388 md:h-224 container grid w-260 grid-cols-1 grid-rows-6 gap-y-8 md:w-504 md:grid-cols-2 md:grid-rows-3 md:gap-x-8 xl:h-152 xl:w-1022 xl:grid-cols-3 xl:grid-rows-2 xl:gap-x-8">
