...
const ColumnCard = ({
  ...
  return (
    <div className="h-257 w-284 rounded-6 p-12 border-1px-solid-gray-30 md:flex md:h-93 md:w-544 md:p-20">
      <div className="relative mb-10 h-152 w-260 md:h-53 md:w-91">
