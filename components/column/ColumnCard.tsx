...
const ColumnCard = ({ card }: { card: Card }) => {
  ...
  return (
    <>
      <div
        onClick={openModal}
        className="flex flex-col w-full h-auto p-12 cursor-pointer rounded-6 border-1px-solid-gray-30 md:h-93 md:flex-row md:p-20 xl:h-auto xl:flex-col"
      >
        <div className="relative w-full mb-10 mr-20 h-152 md:h-53 md:w-91 xl:h-160 xl:w-274">
          <Image
